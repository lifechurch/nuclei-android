...
public final class TaskScheduler {
    ...
    public static void cancel(Context context, nuclei.task.Task<?> task, boolean forceGcm) {
    ...
    public static void cancel(Context context, nuclei.task.Task<?> task) {
        cancel(context, task, false);
    }

    private static void cancelPreL(Context context, nuclei.task.Task<?> task) {
    ...
    public static Builder newBuilder(nuclei.task.Task task, int type) {
