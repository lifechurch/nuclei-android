...
@TargetApi(11)
public class PersistenceLoader implements LoaderCallbacks<Cursor> {
    ...
    public static PersistenceLoader newLoaderManager(Context context, LoaderManager manager) {
