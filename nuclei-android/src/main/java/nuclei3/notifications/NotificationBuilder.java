...
public abstract class NotificationBuilder {
    ...
    public abstract String getChannelId(Context context, NotificationManager manager, String group, List<NotificationMessage> messages);

    public abstract String getChannelId(Context context, NotificationManager manager, NotificationMessage message, List<NotificationMessage> messages);
    ...
    public Notification buildSummary(Context context, NotificationManager manager, String group, List<NotificationMessage> messages) {
        ...
        Builder builder = new Builder(context, getChannelId(context, manager, group, messages))
    ...
    public Notification buildNotification(Context context, NotificationManager manager, NotificationMessage message, List<NotificationMessage> messages) {
        ...
        Builder builder = new Builder(context, getChannelId(context, manager, message, messages))
                .setSmallIcon(manager.getDefaultSmallIcon())
                .setLargeIcon(manager.getDefaultLargeIcon())
                .setOngoing(false)
                .setAutoCancel(true);
