...
public final class Http {
    ...
    private static final nuclei3.logs.Log LOG = Logs.newLog(Http.class);
    ...
    public static void initialize(Application application, HttpPoolBuilder builder) {
        ...
        OkHttpClient client = new OkHttpClient.Builder()
                .cache(new okhttp3.Cache(new File(application.getCacheDir(), "nuclei3-http"), MAX_CACHE_SIZE))
                .build();
        SimpleCache cache = new SimpleCache(new File(application.getCacheDir(), "nuclei3-object"), MAX_CACHE_SIZE);
