...
import nuclei3.media.Queue;
import nuclei3.media.QueueItem;
...
public class PlaybackManager implements Playback.Callback {
    ...
    private void onContinue() {
        mServiceCallback.onCompletion(true);
        if (mQueue != null) {
    ...
    public void onCompletion() {
        if (mAutoContinue) {
            ...
            mServiceCallback.onCompletion(false);
    ...
    public interface PlaybackServiceCallback {
        ...
        void onCompletion(boolean autoContinue);
