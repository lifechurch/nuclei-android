...
public class ButtonBarView extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        final int layout = a.getResourceId(R.styleable.ButtonBarView_control_layout,
                bottom
                ? R.layout.nuclei3_view_button_bar_bottom
                : R.layout.nuclei3_view_button_bar);
    ...
    void dataSetChanged() {
        ...
        for (int i = 0; i < count; i++) {
            ...
            item.view = (ViewGroup) inflater.inflate(
                    mOrientation == 1
                    ? R.layout.nuclei3_view_button_horizontal_bar_item
                    : R.layout.nuclei3_view_button_vertical_bar_item, this, false);
